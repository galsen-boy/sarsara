...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-2">
              <Droplets className="h-8 w-8 text-sarsara-500" />
              <span className="text-2xl font-bold text-sarsara-600 dark:text-sarsara-400">SARSARA</span>
            </div>
            ...
            <div className="flex md:hidden items-center">
              <button
                onClick={toggleTheme}
                className="p-3 rounded-full bg-sarsara-500 text-white hover:bg-sarsara-600 transition-colors shadow-lg"
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button onClick={() => scrollToSection('accueil')} className="text-gray-700 dark:text-gray-300 hover:text-sarsara-600 dark:hover:text-sarsara-400 transition-colors">
                Accueil
              </button>
              <button onClick={() => scrollToSection('produits')} className="text-gray-700 dark:text-gray-300 hover:text-sarsara-600 dark:hover:text-sarsara-400 transition-colors">
                Produits
              </button>
              <button onClick={() => scrollToSection('qualite')} className="text-gray-700 dark:text-gray-300 hover:text-sarsara-600 dark:hover:text-sarsara-400 transition-colors">
                Qualité
              </button>
              <button onClick={() => scrollToSection('contact')} className="text-gray-700 dark:text-gray-300 hover:text-sarsara-600 dark:hover:text-sarsara-400 transition-colors">
                Contact
              </button>
              <button
                onClick={toggleTheme}
      ...
      <section id="accueil" className="relative h-screen flex items-center justify-center bg-gradient-to-br from-sarsara-50 via-white to-sarsara-100 dark:from-gray-800 dark:via-gray-900 dark:to-sarsara-900">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-1/2 -right-1/2 w-full h-full bg-sarsara-100 rounded-full opacity-20 blur-3xl"></div>
        ...
        <div className="relative text-center px-4 sm:px-6 lg:px-8 pt-20">
          ...
          <button
            ...
            className="bg-sarsara-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-sarsara-700 transition-all transform hover:scale-105 shadow-lg"
          >
            Découvrir nos produits
          </button>
          <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
            <ChevronDown className="h-8 w-8 text-sarsara-600" />
          </div>
        </div>
      </section>
      ...
      <section id="produits" className="py-24 bg-gray-50 dark:bg-gray-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="group">
              <div className="bg-gradient-to-br from-gray-50 to-sarsara-50 dark:from-gray-700 dark:to-gray-600 rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
      ...
      <section id="qualite" className="py-24 bg-gradient-to-br from-sarsara-50 to-cyan-50 dark:from-gray-700 dark:to-gray-600 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg text-center">
              <div className="w-16 h-16 bg-sarsara-100 dark:bg-sarsara-900 rounded-full flex items-center justify-center mx-auto mb-6">
                <Droplets className="h-8 w-8 text-sarsara-600" />
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg text-center">
              <div className="w-16 h-16 bg-sarsara-100 dark:bg-sarsara-900 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg className="h-8 w-8 text-sarsara-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-sarsara-100 dark:bg-sarsara-900 rounded-full flex items-center justify-center mb-4">
                <Phone className="h-8 w-8 text-sarsara-600" />
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-sarsara-100 dark:bg-sarsara-900 rounded-full flex items-center justify-center mb-4">
                <Mail className="h-8 w-8 text-sarsara-600" />
              </div>
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 bg-sarsara-100 dark:bg-sarsara-900 rounded-full flex items-center justify-center mb-4">
                <MapPin className="h-8 w-8 text-sarsara-600" />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-2 mb-4 md:mb-0">
              <Droplets className="h-6 w-6 text-sarsara-400" />
